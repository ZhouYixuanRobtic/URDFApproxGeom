...
namespace igl
{
  ...
  /// @param[out] boundaries  Edges with only one incident triangle, as a #boundaries-by-2
  ...
  /// @param[out] foldovers  Edges where the two incident triangles fold over each other
