...
namespace igl
{
  ...
  /// is reached.
  ///
  /// @param[in] Vin        #V by 3 eigen Matrix of mesh vertex 3D positions
  ...
  /// @param[out] Vout       #V by 3 eigen Matrix of planar mesh vertex 3D positions
  ///
  template <typename DerivedV, typename DerivedF>
  IGL_INLINE void planarize_quad_mesh(
