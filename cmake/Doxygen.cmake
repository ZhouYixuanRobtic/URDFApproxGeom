...
function(myproject_enable_doxygen DOXYGEN_THEME DOXYGEN_EXCLUDE_DIRS)
  ...
  # svg files are much smaller than jpeg and png, and yet they have higher
  # quality
  set(DOXYGEN_DOT_IMAGE_FORMAT svg)
  set(DOXYGEN_DOT_TRANSPARENT YES)

  # If not specified, exclude the vcpkg files and files CMake downloads under
  # _deps Append external exclude directories
  ...
  # Add user-specified exclusion directories
  foreach(path IN LISTS DOXYGEN_EXCLUDE_DIRS)
    if(IS_DIRECTORY ${path})
      list(APPEND DOXYGEN_EXCLUDE_PATTERNS "${path}/*")
      message(STATUS "Excluding path '${path}' from doxygen.")
    elseif(EXISTS ${path})
      list(APPEND DOXYGEN_EXCLUDE_PATTERNS "${path}")
      message(STATUS "Excluding path '${path}' from doxygen.")
    else()
      message(STATUS "Path '${path}' does not exist and will be ignored.")
    endif()
  endforeach()
  ...
  if("${DOXYGEN_THEME}" STREQUAL "awesome" OR "${DOXYGEN_THEME}" STREQUAL
                                              "awesome-sidebar")
    # use a modern doxygen theme https://github.com/jothepro/doxygen-awesome-css
    # v1.6.1
