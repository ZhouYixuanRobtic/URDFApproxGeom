...
#
# # Example add_executable(main_cuda main.cu) target_compile_features(main_cuda
# PRIVATE cxx_std_17) target_link_libraries(main_cuda PRIVATE project_options
# project_warnings) target_link_cuda(main_cuda)
#
macro(myproject_target_link_cuda target)
  ...
  if(APPLE)
    # We need to add the path to the driver (libcuda.dylib) as an rpath, so that
